...
> {{SINTESE_DA_IDEIA_VIVA_QUE_O_PAI_DEVE_INTERNALIZAR_EM_UMA_FRASE_CURTA_E_INSPIRADORA}}
>
...
> *"Viajante, vamos construir o que o Guardião nos mostrou?"*
>
...
> *   **Ação:** {{ATIVIDADE_CINETICA_PULAR_CORRER_BUSCAR}}
...
> *   "{{PERGUNTA_ABERTA_QUE_CONECTA_O_TEMA_A_VIDA_REAL_DA_CRIANCA}}"
> *   "{{PERGUNTA_IMAGINATIVA_SE_VOCE_FOSSE_O_GUARDIAO_O_QUE_FARIA}}"
...
> [!RITUAL]
> **Você diz:**
> "O Reino adormece, mas a melodia do {{SIMBOLO_DA_LICAO_QUE_FICA_NA_MEMORIA}} continua ecoando em seu coração."
